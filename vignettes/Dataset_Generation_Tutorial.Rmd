...
-   In case you are using `gcamreport` package following the [R installation](#with-r), try to copy the whole path to your data, for instance `db_path = C:\Users\username\Documents\path\to\your\database` if you are using a Windows distribution.
