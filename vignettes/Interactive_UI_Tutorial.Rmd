...
To see all possibilities of the `run()` function, look [here](https://bc3lc.github.io/gcamreport/reference/run.html), and of the `launch_gcamreport_ui()`, look [here](https://bc3lc.github.io/gcamreport/reference/launch_gcamreport_ui.html).
