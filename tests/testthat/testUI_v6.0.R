...
test_that("Test1. test tree functions", {
  ...
  testResult1.2 <- do_unmount_tree(get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_unmount_tree_regions.RData"))), "regions")
  testExpect1.2 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_1.2.RData")))
  ...
  testExpect2 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_2.RData")))
  testthat::expect_equal(testResult2, testExpect2)

  # do_unmount_tree with variables
  testResult2.2 <- do_unmount_tree(get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_unmount_tree_variables.RData"))), "variables")
  testExpect2.2 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_2.2.RData")))
  ...
  testExpect3 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_3.RData")))
  testthat::expect_equal(testResult3, testExpect3)

  # change_style
  test4_pre <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_4_pre.RData")))
  testExpect4 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_4_post.RData")))
  ...
  testExpect5 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_5.RData")))
  ...
  testExpect6 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_6.RData")))
  ...
  testExpect7 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_7.RData")))
...
test_that("Test2. error messages", {
  ...
  errorExpect1 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_error1.RData")))
  ...
  errorExpect2 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_error2.RData")))
  ...
  errorExpect3 <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_error3.RData")))
...
test_that("Test3. reset", {
  ...
  testthat::expect_equal(
    tree_reg,
    get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_3.a.RData")))
  )
  testthat::expect_equal(
    cols.global,
    get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_3.b.RData")))
  )
  testthat::expect_equal(
    all_varss,
    get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_3.c.RData")))
  )
})
...
test_that("Test5. do_data_sample", {
  ...
  # do_data_sample
  sdata <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_ui_5.sdata.RData")))
  sel_cols <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_ui_5.sel_cols.RData")))
  sel_reg <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_ui_5.sel_reg.RData")))
  sel_scen <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_ui_5.sel_scen.RData")))
  sel_vars <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_ui_5.sel_vars.RData")))
  sel_years <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_ui_5.sel_years.RData")))
  testResult <- do_data_sample(sdata, sel_scen, sel_years, sel_cols, sel_vars, sel_reg, 0, 0)
  testExpect <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_5.1.RData")))
  ...
  testExpect <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_5.2.RData")))
  testthat::expect_equal(testResult, testExpect)

  testResult <- do_data_sample(sdata, sel_scen, sel_years, sel_cols, sel_vars, sel_reg, 1, 1)
  testExpect <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_5.3.RData")))
  testthat::expect_equal(testResult, testExpect)

  testResult <- do_data_sample(sdata, sel_scen, sel_years, sel_cols, sel_vars, sel_reg, 2, 1)
  testExpect <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_5.4.RData")))
  testthat::expect_equal(testResult, testExpect)

  testResult <- do_data_sample(sdata, sel_scen, sel_years, sel_cols, sel_vars, sel_reg, 1, 2)
  testExpect <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_5.5.RData")))
  testthat::expect_equal(testResult, testExpect)
})
...
test_that("Test6. update_user_choices_plot", {
  ...
  tree_regions <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_ui_6.tree_regions.RData")))
  tree_variables <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testInputs/v_6.0/test_ui_6.tree_variables.RData")))
  testResult <- update_user_choices_plot(selected_scen, selected_years, tree_regions, tree_variables, sidebarItemExpanded)
  testExpect <- get(load(file.path(rprojroot::find_root(rprojroot::is_testthat), "testOutputs/v_6.0/test_ui_6.1.RData")))
  testthat::expect_equal(testResult, testExpect)
