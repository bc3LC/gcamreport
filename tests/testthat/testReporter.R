...
test_that("Test2. load project function test", {
...
test_that("Test3. run function test: dataset created", {
...
test_that("Test4. run function test: dataset saved with file_name specified", {
  ...
  run(
    project_path = paste0(rprojroot::find_root(rprojroot::is_testthat), "/testInputs/test6.dat"), launch_ui = FALSE,
...
test_that("Test5. run function test: dataset saved with default file_name", {
...
test_that("Test6. load variable test", {
