...
# ag maps
fertilizer_map_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "fertilizer_map.csv"),
                                       comment = "#"
) %>% gather_map()
use_data(fertilizer_map_v7.2, overwrite = T)
...
yield_map_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "yield_map.csv"),
                                               comment = "#"
)
...
food_expenditures_average_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "food_expenditures_average.csv"),
                                                   comment = "#"
)
use_data(food_expenditures_average_v7.2, overwrite = T)
...
food_cal_mt_kg_conversion_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "food_cal_mt_kg_conversion.csv"),
                                                        comment = "#"
)
use_data(food_cal_mt_kg_conversion_v7.2, overwrite = T)
...
# Energy Service maps
en_multiplier_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "en_multiplier.csv"),
                                                          comment = "#"
)
use_data(en_multiplier_v7.2, overwrite = T)
...
hdd_cdd_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "hdd_cdd.csv"),
                                      comment = "#"
) %>% gather_map()
use_data(hdd_cdd_v7.2, overwrite = T)
...
nonelec_investment_map_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "nonelec_investment_map.csv"),
                                               comment = "#", na = ""
) %>% gather_map()
use_data(nonelec_investment_map_v7.2, overwrite = T)
...
conveyance.eff_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "conveyance.eff.csv"), comment = "#")
use_data(conveyance.eff_v7.2, overwrite = T)
