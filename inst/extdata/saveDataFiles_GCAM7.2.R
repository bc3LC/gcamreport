...
# emissions maps
carbon_densities_vegsoil_v7.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM7.2", "carbon_densities_vegsoil.csv"),
                                                 comment = "#", na = "")
use_data(carbon_densities_vegsoil_v7.2, overwrite = T)
