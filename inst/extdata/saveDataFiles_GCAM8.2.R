...
food_cal_mt_kg_conversion_v8.2 <- readr::read_csv(file.path(rawDataFolder, "inst/extdata/mappings/GCAM8.2", "food_cal_mt_kg_conversion.csv"),
                                                  comment = "#"
)
use_data(food_cal_mt_kg_conversion_v8.2, overwrite = T)
