...
#' @source local
#' @format vector
#' @description gcamreport queries compatible with GCAM Europe 8.7 version.
#' Contain all queries except for nonCO2 queries
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::queries_general_vEurope8.7
#' }
"queries_general_vEurope8.7"
...
#' @source local
#' @format vector
#' @description gcamreport nonCO2 query compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::queries_nonCO2_vEurope8.7
#' }
"queries_nonCO2_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::nonco2_emissions_list_vEurope8.7
#' }
"nonco2_emissions_list_vEurope8.7"
...
#' @source local
#' @format .csv
#' @description mapping between variables, functions to load them, dependent variables, and available verifications compatible with GCAM Europe 8.7.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::var_fun_map_vEurope8.7
#' }
"var_fun_map_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description read in template compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::template_vEurope8.7
#' }
"template_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description emissions maps compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::co2_ets_sector_map_vEurope8.7
#' }
"co2_ets_sector_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::co2_tech_map_vEurope8.7
#' }
"co2_tech_map_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description emissions map by resource production compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::co2_resource_map_vEurope8.7
#' }
"co2_resource_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::kyoto_sector_map_vEurope8.7
#' }
"kyoto_sector_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::nonco2_emis_sector_map_vEurope8.7
#' }
"nonco2_emis_sector_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::nonco2_emis_resource_map_vEurope8.7
#' }
"nonco2_emis_resource_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::carbon_seq_tech_map_vEurope8.7
#' }
"carbon_seq_tech_map_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description ag maps compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::ag_demand_map_vEurope8.7
#' }
"ag_demand_map_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description ag maps compatible with Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::fertilizer_map_vEurope8.7
#' }
"fertilizer_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::ag_price_map_vEurope8.7
#' }
"ag_price_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::ag_demand_price_map_vEurope8.7
#' }
"ag_demand_price_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::ag_production_map_vEurope8.7
#' }
"ag_production_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::trade_ag_vEurope8.7
#' }
"trade_ag_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::land_use_map_vEurope8.7
#' }
"land_use_map_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description ag maps compatible with yield_map_vEurope8.7
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::yield_map_vEurope8.7
#' }
"yield_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::food_intake_map_vEurope8.7
#' }
"food_intake_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::food_items_map_vEurope8.7
#' }
"food_items_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::food_expenditures_average_vEurope8.7
#' }
"food_expenditures_average_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description food waste share (waste/supppy) compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
...
#' @source github
#' @format .csv
#' @description primary, secondary, final energy maps compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::primary_energy_map_vEurope8.7
#' }
"primary_energy_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::production_map_vEurope8.7
#' }
"production_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::capacity_map_vEurope8.7
#' }
"capacity_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::final_energy_map_vEurope8.7
#' }
"final_energy_map_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description primary, secondary, final energy demand - price maps compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::en_demand_price_map_vEurope8.7
#' }
"en_demand_price_map_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description resource extraction map compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::res_extraction_map_vEurope8.7
#' }
"res_extraction_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::transport_final_en_map_vEurope8.7
#' }
"transport_final_en_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::energy_price_map_vEurope8.7
#' }
"energy_price_map_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description transport energy services compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::transport_en_service_vEurope8.7
#' }
"transport_en_service_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description energy services compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::en_multiplier_vEurope8.7
#' }
"en_multiplier_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description buildings energy services compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::buildings_en_service_vEurope8.7
#' }
"buildings_en_service_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description capital update compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::capital_gcam_vEurope8.7
#' }
"capital_gcam_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description capital investment compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::investment_vEurope8.7
#' }
"investment_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description carbon content compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::carbon_content_vEurope8.7
#' }
"carbon_content_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description non CO2 content compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::nonco2_content_vEurope8.7
#' }
"nonco2_content_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description iea 2019 capacity compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::iea_capacity_vEurope8.7
#' }
"iea_capacity_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description new CO2 market compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::co2_market_vEurope8.7
#' }
"co2_market_vEurope8.7"
...
#' @source github
#' @format .csv
#' @description new CO2 regional markets map compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::co2_market_frag_map_vEurope8.7
#' }
"co2_market_frag_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::iron_steel_trade_map_vEurope8.7
#' }
"iron_steel_trade_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::water_map_vEurope8.7
#' }
"water_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::conveyance.eff_vEurope8.7
#' }
"conveyance.eff_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::ucd_size_class_vEurope8.7
#' }
"ucd_size_class_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::ucd_core_vEurope8.7
#' }
"ucd_core_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::transport_sales_map_vEurope8.7
#' }
"transport_sales_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::transport_stock_map_vEurope8.7
#' }
"transport_stock_map_vEurope8.7"
...
#' \dontrun{
#' library(gcamreport)
#' gcamreport::GHG_gases_vEurope8.7
#' }
"GHG_gases_vEurope8.7"

#' gcameurope.EUROSTAT_COUNTRIES_vEurope8.7
#'
#' @description list of GCAM Europe 8.7 countries with Eurostat data available
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::gcameurope.EUROSTAT_COUNTRIES_vEurope8.7
#' }
"gcameurope.EUROSTAT_COUNTRIES_vEurope8.7"

#' last_historical_year_vEurope8.7
#'
#' @description last historical year compatible with GCAM Europe 8.7 version.
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::last_historical_year_vEurope8.7
#' }
"last_historical_year_vEurope8.7"
...
#' @source local
#' @format .csv
#' @description mapping between regions and continents compatible with GCAM Europe 8.7 version
#' @examples
#' \dontrun{
#' library(gcamreport)
#' gcamreport::reg_cont_vEurope8.7
#' }
"reg_cont_vEurope8.7"
